...
The thing that stood out was that essentially attr writer and reader could replace the functions being used within the code. Also, they are instance variables, so the latter two private functions did not need parameters.
