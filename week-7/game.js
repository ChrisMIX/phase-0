  ...
  var dracofight = function(){
    ...
    var weaponchoice = prompt("You have two weapons to choose from. Which do you pick? (1 for a broadsword of 5 attack power, and 2 for a bow of 1 attack power.")
      ...
      if(choice == 1){
        ...
        console.log("Where would you like to aim? Oh and just fyi, the dragon is preparing to breathe some fire. This may be your only chance so use it well...")
        var target = prompt("Specify a location for the arrow. Use lowercase., target here")
